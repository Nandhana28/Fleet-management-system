  ...
  return (
    <AuthLayout title="Create your account" subtitle="Start managing your fleet with real-time intelligence">
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 22 }}>
        ...
        <span style={{ fontSize: 13, color: '#94a3b8', fontWeight: 500 }}>or sign up with email</span>
        <div style={{ flex: 1, height: 1, background: '#e5e7eb' }} />
      </div>
      ...
      <form onSubmit={handleSignup} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
        <div>
          ...
          <input className="auth-input" type="text" placeholder="Rajesh Kumar" value={form.name} onChange={set('name')} />
        </div>
        ...
        <div>
          ...
          <div style={{ position: 'relative' }}>
            <div style={{ position: 'absolute', left: 14, top: '50%', transform: 'translateY(-50%)', fontSize: 13, color: '#374151', fontWeight: 500, borderRight: '1px solid #e5e7eb', paddingRight: 10 }}>+91</div>
            <input className="auth-input" type="tel" placeholder="98765 43210" value={form.phone} onChange={set('phone')} style={{ paddingLeft: 52 }} />
          </div>
        </div>
        ...
        <div>
          ...
          <div style={{ position: 'relative' }}>
            <input className="auth-input" type={showPassword ? 'text' : 'password'} placeholder="Minimum 8 characters" value={form.password} onChange={set('password')} style={{ paddingRight: 44 }} />
        ...
        <div>
          ...
          <input className="auth-input" type="password" placeholder="Repeat your password" value={form.confirm} onChange={set('confirm')} />
        </div>
